...
/**
 * Clase que define las operaciones b�sicas que debe tener una lista simple.
 * @author xavier
 */
public class Ej03_Lista {
    ...
    /**
     * Inserta un nuevo nodo despues en una posici�n determinada.
    ...
    /**
     * Obtiene el valor de un nodo en una determinada posici�n.
    ...
    /**
     * Consulta la posici�n de un elemento en la lista
     * @param referencia valor del nodo el cual se desea saber la posici�n.
     * @return un valor entero entre [0,n] que indica la posici�n del nodo. 
     * @throws Exception 
     */
