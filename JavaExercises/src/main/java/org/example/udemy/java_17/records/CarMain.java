package org.example.udemy.java_17.records;
...
public class CarMain {
    public static void main(String[] args) {
        ...
        // 2. Using a record
        System.out.println("--------------- 2. Using a record ----------------");
