package org.example.udemy.localisation;
...
public class BundleSearching {
    public static void main(String[] args) {
        System.out.println("---------------------defaultLocaleIrrelevant------------------------");
        defaultLocaleIrrelevant();
        System.out.println("---------------------ignoreAmericanBundle------------------------");
        ignoreAmericanBundle();
        System.out.println("---------------------usingDefaultLocale------------------------");
        usingDefaultLocale();
    }
