...
class Manx extends CatB{}

public class SuperAndExtends {
    public static void addAnimal(Animal[] animals){
        animals[0] = new Dog();
      //  animals[1] = new CatB();// ArrayStoreException generated -  JVM knows the type
    }
    ...
    public static void main(String[] args) {
        ...
        List<CatB> cats1 = new ArrayList<CatB>();
        // polyorphism not ok for the generic type; Animal -> Cat
        //       List<Animal> animals = new ArrayList<Cat>();
        List<CatB> cats2  = new ArrayList<CatB>(); // generic types on both sides must match
        List<CatB> cats3 = new ArrayList<>();     // or use type inference
...
//        animals1.add(new Animal());// read-only
        ...
        List<? extends Animal> animals3 = new ArrayList<CatB>();
...
//        List<? super Dog> dogs4 = new ArrayList<Terrier>();
        ...
        List<CatB> cats         = new ArrayList<>(); cats.add(new CatB());
...
//        spr(manxCats);// compiler error: Manx is not Cat or a supertype of Cat    - not OK
    ...
    public static void spr(List<? super CatB> list){ // The "lower-bound" is Cat.
        ...
        list.add(new CatB());    // Cat is-a Cat (Cat is-an Animal, Cat is-an Object)
...
//        list.add(new CatB());      // compiler error if we try to modify 'list'
